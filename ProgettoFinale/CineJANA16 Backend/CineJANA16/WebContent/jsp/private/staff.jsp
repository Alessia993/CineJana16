...
<html>
	...
	<body>
		...
		<% Utente utente = (Utente) session.getAttribute(Costanti.CHIAVE_SESSIONE_STAFF); 
                ...
                <div class="container">
                    ...
                    <div class="default-heading-shadow">
						...
						<% String mex = (String) request.getAttribute(Costanti.CHIAVE_PRENOTAZIONE); 
										...
										%>
											<h3 class="mexOk"> Prenotazione effettuata </h3>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12">
                            ...
                            <div class="events-item">
                                <div class="figure">
                                    <!-- image -->
                                    <img class="img-responsive" src="/CineJANA16/img/featured/ModificaProfiloStaff.png" alt=""
                                        width="100%" />
                                </div>
                                <!-- event information -->
                        ...
                        <div class="col-md-3 col-sm-12">
                            ...
                            <div class="events-item">
                                <!-- image container -->
                                <div class="figure">
                                    <img class="img-responsive" src="/CineJANA16/img/featured/aggiungiFilm.png" alt="" width="100%" />
                                </div>
                                <!-- event information -->
                                <div class="event-info">
                        ...
                        <div class="col-md-3 col-sm-12">
                            ...
                            <div class="events-item">
                                <!-- image container -->
                                <div class="figure">
                                    <img class="img-responsive" src="/CineJANA16/img/featured/aggiungiSpettacolo.png" alt="" width="100%" />
                                </div>
                                <!-- event information -->
                                <div class="event-info">
                                    <!-- nome film -->
