...
<html>
	<head>
		...
		<title>Inserisci una nuova sala</title>
	    ...
	    <div class="wrapper" id="home">
	        ...
	        <div class="container-fluid" id="accediCont">
	            <div class="form-content ">
	                <!-- paragraph -->
	                <h1>Inserisci Sala</h1>
	                <form action="/CineJANA16/InserisciSalaServlet" role="form" id="contactForm" method="post">
	                    <div class="row" id="accediRow">
	                        <div class="col-md-12 col-sm-12">
	                                    <div class="form-group">
	                                    <input type="text" class="inputForm" placeholder="Nome della sala" name="nome"
	                                        required>
	                                </div>
	                                <div class="form-group">
	                                    <input type="number" min="0" class="inputForm" placeholder="Numero posti"
	                            ...
	                            <div class="form-group">
	                                <% String mex = (String) request.getAttribute(Costanti.CHIAVE_MEX_ERRORE);
										...
										<% }else if(mex!=null && mex.equals("nomeSala")){ %>
											...
											<h3 class="mexErr"> Sala già esistente</h3>
